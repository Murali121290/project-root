...
resource "aws_subnet" "main" {
  ...
  tags = { Name = "${var.project_tag}-subnet" }
}
...
resource "aws_instance" "jenkins" {
  ...
  tags = { Name = "${var.project_tag}-jenkins", Project = var.project_tag, Role = "jenkins" }
...
resource "aws_instance" "sonar" {
  ...
  subnet_id     = aws_subnet.main.id
  vpc_security_group_ids = [aws_security_group.allow_web.id]
  tags = { Name = "${var.project_tag}-sonar", Project = var.project_tag, Role = "sonarqube" }
...
resource "aws_instance" "minikube" {
  ...
  subnet_id     = aws_subnet.main.id
  vpc_security_group_ids = [aws_security_group.allow_web.id]
  tags = { Name = "${var.project_tag}-minikube", Project = var.project_tag, Role = "minikube" }
